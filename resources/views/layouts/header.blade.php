  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="assets/img/della.jpg" alt="" class="img-fluid rounded-circle">
        <h1 class="text-light" ><a href="index.html">Della Jannata F</a></h1>
        <div class="social-links mt-3 text-center">
          <a href="https://www.instagram.com/dellajannata/?hl=id" class="instagram"><i class="bx bxl-instagram"></i></a>
          <a href="https://github.com/dellajannata" class="gitHub"><i class="bx bxl-github"></i></a>
        </div>
      </div>
